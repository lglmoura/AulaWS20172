...
import br.edu.iff.pooa20172.aulaws20172.adapter.ClickRecyclerViewListener;
import br.edu.iff.pooa20172.aulaws20172.adapter.MarcaAdapter;
import br.edu.iff.pooa20172.aulaws20172.helper.RestFullHelper;
import br.edu.iff.pooa20172.aulaws20172.model.Marca;
...
public class MarcaActivity extends AppCompatActivity implements ClickRecyclerViewListener {
    ...
    public void onClick(Object object) {
        ...
        Toast.makeText(getContext(),marca.getName()+" "+marca.getId(),Toast.LENGTH_SHORT).show();
